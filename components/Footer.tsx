      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-10 border-b border-white/10 pb-10">
        ...
        >
          <h2 className="text-2xl font-serif text-white mb-4">
            <span className="text-[#7a5a1e] text-3xl">Luxury</span><span className="text-[#dd2525]">homes</span>
          </h2>
  ...
  >
    <Icon size={18} />
      ...
      <div className="mt-8 flex flex-col md:flex-row items-center justify-between text-sm text-gray-500">
        <p>{new Date().getFullYear()} Luxuryhomes. <br /> <span className="text-red-700 text-center">@chiragha All rights reserved.</span></p>
